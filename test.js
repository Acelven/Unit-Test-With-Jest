...
test("One Dollar should be 106.58 Yens", function(){
    ...
    // this is the comparison for the unit test
     expect(fromDollarToYen(3.5)).toBeCloseTo(373.03, 1); //1 Dollar are 106.58 Yens, then 3.5 Dollars should be = (3.5 * 106.58)
})
...
test("One Pound should be 0.0062 Yen", function(){
    ...
    // if 1 Yen is 0.0062 Pounds, then 150 Yens should be = (150 * 0.0062)
    const expected = 150 * 0.8 / 127.9; 
